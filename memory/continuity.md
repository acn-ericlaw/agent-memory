...
- Target-repo scope only — never read/modify/move anything outside the resolved
  ...
  <!-- id: target-repo-scope-only | created: 2026-06-13 | last_used: 2026-06-18 | uses: 12 | tier: core | adr: ADR-0001 -->
- Never delete vendor files — move originals to `legacy/<vendor>/`, preserving paths
  <!-- id: never-delete-vendor-files | created: 2026-06-13 | last_used: 2026-06-18 | uses: 8 | tier: core | adr: ADR-0002 -->
- Never overwrite, never pick a winner — fold vendor steering under
  ...
  <!-- id: never-pick-a-winner | created: 2026-06-13 | last_used: 2026-06-18 | uses: 14 | tier: core | adr: ADR-0003 -->
- No build step; agent-run — the tool itself runs no code and needs none (no install, no
  ...
  <!-- id: no-build-step-agent-run | created: 2026-06-16 | last_used: 2026-06-20 | uses: 31 | tier: core | supersedes: no-code-markdown-only | origin: 2026-06-16-002134 | adr: ADR-0006 -->
- Upgrades are additive and non-destructive — enrich and add, never rewrite or delete —
  **except the tool's own managed built-ins** (`memory-lint`, `second-opinion`, `apply-critique`),
  ...
  <!-- id: upgrades-additive | created: 2026-06-13 | last_used: 2026-06-20 | uses: 22 | tier: core | adr: ADR-0005 -->
...
- [x] **Shipped v4.14.0 (MINOR) — optional Architecture Decision Record log (`docs/ADR.md`).**
  ...
  **map-don't-duplicate** cross-linking (`formalizes:` ↔ `adr:`). Lockstep: `docs/ADR.md` (new),
